    ...
    if (($uspjesnaPrijava == true && $admin == true) || (isset($_SESSION['username']) && $level == 1)) {
        ...
        echo '<form enctype="multipart/form-data" action="" method="POST" >
                ...
                <div id="form-item">
                    ...
                    <div id="form-field">
                        <textarea name="about" id="textarea" cols="30" rows="10" class="form-field-textual">'.$row['sazetak'].'</textarea>
                    </div>
                </div>
                ...
                <div id="form-item">
                    ...
                    <div id="form-field">
                        <textarea name="sadrzaj" id="textarea" cols="30" rows="10" class="form-field-textual">'.$row['tekst'].'</textarea>
                    </div>
                </div>
                <div class="form-item">
